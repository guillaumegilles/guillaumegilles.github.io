...
title: "AI Space"
abstract: |
  You are assigned the important mission of locating and identifying the infamous space hacker. Your investigation begins by analyzing the data patterns and breach points entified in the latest cyber-attacks. Use the provided coordinates of the last known signal origins to narrow down his potential hideouts. Utilize advanced tracking algorithms to follow the digital footprint left by the hacker.
categories: [HTB, challenges, AI - ML]
draft: true
---

AI Space is a [challenge](https://app.hackthebox.com/challenges/AI%2520SPACE) designed by [karamuz](https://app.hackthebox.com/users/290068). It starts with a NumPy file, `distance_matrix.npy`. NumPy is a Python library to operate on multidimensional arrays, _a.k.a._ matrices.
