...
D.$NiQ;$3k Basic big-fat-deck Faut-il écrire « avoir à faire » ou « avoir affaire » ? "On peut remplacer cette expression par « avoir à réaliser (quelque chose) » ou « avoir à refaire » ? Il faut alors écrire « à faire » :<br><br><div style=""text-align: center;"">Il <b>a</b> fort <b>à faire</b> pour rattraper son retard</div><br>Sinon, c’est de « affaire » qu’il s’agit, et il est presque toujours suivi de « à ». Pour s’en assurer, on peut remplacer l’expression « avoir affaire » par « être en rapport avec » :<br><br><div style=""text-align: center;"">Le médecin <b>à qui</b> le malade <b>a eu affaire</b> était un charlatan. = Le médecin <b>avec qui</b> le malade <b>a été en rapport</b> était en charlatan.</div>" voltaire
km|5l3DwYB Basic big-fat-deck Faut-il écrire « une qualitée » ou « une qualité », « l’amitiée » ou « l’amitié » ? "Les noms féminins se terminant par « -té » ou « -tié » ne prennent pas de « -e » :<br><br><div style=""text-align: center;"">Il fait preuve d’une grande <b>autorité</b>.</div><br><u>À l’exception des noms suivants</u> :<br><ul><li>La montée ;</li><li>La butée ;</li><li>La dictée ;</li><li>La jetée ;</li><li>La portée ;</li><li>La pâtée ;</li><li>Les noms exprimant un contenu (une assiettée, une pelletée, etc.).</li></ul><div style=""text-align: center;"">Je n’ai fait qu’une faute lors de la <b>dictée</b>.</div>" voltaire
cqZ}[bBbEG Basic big-fat-deck Faut-il écrire « -é » ou « -er » ? "Si on peut remplacer le mot par « finir », « faire » ou tout autre infinitif qui ne soit pas du 1<sup>er</sup> groupe ? Dans ce cas, c’est un infinitif qui se termine par « -er » :<br><br><div style=""text-align: center;"">Voici les formulaires à <b>imprimer</b>. = Voici les formulaires à remplir.</div><br>Sinon, il s’agit du participe passé, <u>à accorder en genre et en nombre</u> (« -é », « -ée », « -és », « -ées ») :<br><br><div style=""text-align: center;"">J’ai <b>imprimé</b> les formulaires.</div>" voltaire
xaeRd^CcVJ Basic big-fat-deck Doit-on écrire « <b>si ils </b>venaient, je serais heureux » ou « <b>s’ils</b> venaient, je serais heureux ». Devant le pronom « ils », le « i » de « si » disparaît et est remplacé par une apostrophe. On écrira toujours « s’ils ». voltaire
w-MnMrO[m] Basic big-fat-deck Faut-il écrire « développement », « dévelloppement », « dévelopement » ? Dans « <b>développement </b>», une seule consonne est doublée : le « p ». Si on doublait le « l », on entendrait [dévèlloppement]. voltaire
...
La période de l’industrialisation, du milieu du 19e jusqu’au début du 20e, est l’objet d’une transformation radicale de la société française. La part des ouvriers de l’industrie est multipliée par deux et représente, aux prémices de la guerre, près des deux tiers de la population. C’est une période de métamorphose du contrat de travail. Après la guerre et jusqu’en 1980, les mutations de la société s’accélèrent. Les entreprises ont besoin que leur force de travail reste pour pouvoir se former en même temps que les techniques, les méthodes évoluent.

Quelques repères contextuels :
• Besoin de reconstruire après la guerre ;
• Évolution rapide des technologies qui s’accompagne d’un besoin accru de main d’œuvre qualifiée partout en Europe ;
• Forte croissance économique (30 Glorieuses) ;
• Baisse de la paysannerie ;
• Développement de la participation des femmes à la vie active ;
• Montée en puissance du salariat employé de service à partir des années 70, avec dans la même période, une diminution significative du nombre de salariés ouvriers.

Le contrat salarial est alors la monnaie d’échange de l’employeur envers le salarié pour qu’il reste dans l’entreprise. Il confère aux travailleurs des garanties collectives de protections sociales. Le salariat devient alors partout le modèle de référence.

À partir des années 1980 : le déclin du salariat
Dans les années 1980, 90% des actifs sont salariés. On pensait arriver à une salarisation complète de la force de travail, mais :
• L’image de l’entrepreneur se voit redorée, entraînant un rebond du nombre de travailleurs indépendants dès le début des années 1980 ;
• L’entrepreneuriat permet de se prémunir du chômage ;
• Les travailleurs indépendants permettent aux entreprises de faire baisser le coût de la main d’œuvre. La part de sous-traitance augmente tandis que les organisations se concentrent sur leur cœur de métier.

Indépendants mais subordonnés ?
Par rapport au statut d’indépendant, le statut de salarié se distingue par 3 caractéristiques :
• Une prestation de travail ;
• Une rémunération ;
• Une subordination.
Or, à partir de la fin des années 1980, on constate une porosité croissante entre les statuts de salariés et de non-salariés, par exemple sous la forme de situations de faux travail indépendant ou de fausse sous-traitance. Certains nouveaux travailleurs indépendants, poussés à le devenir par leur entreprise dans une logique d’optimisation des coûts salariaux, demeurent complètement liés à leur ancien employeur qui est en fait leur unique donneur d'ordre. La subordination n’est donc plus réservée aux salariés !

L’affaiblissement du statut de salarié
Une autre raison majeure de l’ébranlement de la société salariale tient à la stabilité désormais moindre offerte par le statut de salarié :
• Le nombre de contrats à durée déterminée augmente de façon significative : d’après l’INSEE, 87 % des nouvelles embauches hors intérim se font en CDD ;
• La durée des périodes d’essai s’allonge ;
• Les « zero hour contracts » au Royaume-Uni sont également un bon exemple : plus d’un million de personnes sont touchées par ce contrat hyper précaire ne garantissant aucun temps de travail.

En parallèle, des lois favorables à l’entrepreneuriat ont été promulguées :
• En France, les lois de 1996 relatives à l’entreprise individuelle, de 2003 sur la micro-entreprise et de 2008 sur l’auto-entrepreneuriat ont permis de développer ces statuts d’indépendants en étendant aux non-salariés certains avantages de la protection sociale ;
• Les lois relatives à la flexisécurité en France et en Europe cherchent, dans la même veine, à doter chacun des moyens de se former tout au long de la vie pour rester adaptable sur le marché de l’emploi.

Pourquoi c’est important ?
Cette focalisation historique sur les statuts du travail était nécessaire pour bien comprendre ce qui se joue depuis 2015 en matière d’évolution de l’emploi :
• Les plateformes comme Uber ou Deliveroo optimisent à l’excès le code du travail afin de faire travailler des indépendants dans des relations où la subordination est très ambiguë ;
• Les plateformes de micro-travail comme Amazon Turk permettent à des entreprises d’externaliser de tout petits segments de leur activité.

Les racines de ces phénomènes récents remontent donc à plus loin qu’on ne l’imagine, mais le digital remet ces questions sur le devant de la scène car elles interrogent notre vision du travail. Il semblerait que nous nous dirigions progressivement vers l’avènement d’un modèle nouveau où le travail indépendant se substitue progressivement à l'emploi salarié. « L'entreprise contemporaine cessant d'être une structure constituée d'emplois pour se transformer rapidement en un champ de travail à accomplir » deviendrait une sorte de « répartiteur de projets » (Bridges, 1995).

On pourrait désormais ajouter : un répartiteur de tâches, avec l’apparition de ceux que l’on appelle labellisateurs, ou “travailleurs du clic” à voir avec le documentaire di même nom.

CSPOC Révolution digitale

Module 4

L’économie de l’attention

La notion d’économie de l’attention n’est pas nouvelle. Le basculement de nos économies « traditionnelles » vers une économie de l’attention se confirme dès les années 70. En 2004, Patrick le Lay, PDG de TF1, parlait de “vendre du temps de cerveau disponible” pour aider les marques à commercialiser leurs produits. Quelques années plus tard, en 2017, le PDG de Netflix se déclarait ”en concurrence avec le sommeil”.

Pour les entreprises du numérique, l’attention se mesure de manière quantitative. C’est le fameux **trafic** que l’on mesure en _taux de clics_ et en _nombre de vues_. La valeur ne se trouve plus tant dans le contenu en tant que tel que dans la capacité à attirer l’attention du “consommateur”. La **monétisation** vient ensuite. Elle s’opère par la vente de publicités ou plus indirectement par la revente des données à des tiers qui les utiliseront pour obtenir la très recherchée “attention”.

=> infobésité

Agir sur les désirs

Cette course à la sollicitation donne lieu, en conséquence, “à un déferlement d’images et d’informations qui nous condamne à un déficit attentionnel pathologique” et qui déforme nos désirs.

Le chercheur suisse Yves Citton nous explique que les désirs des individus ne sont pas naturels, ils viennent de nos environnements. On veut quelque chose car on nous a appris à trouver cette chose intéressante. On retrouve dans cette idée des éléments proches de la notion de **soft power** développée durant la guerre froide. L’économie de l’attention semble en être une suite logique, par sa volonté de créer des environnements de pensée susceptibles de conditionner un comportement.

@à-mettre-lien-avec-la-propagande[propaganda]

Ce phénomène prend une dimension nouvelle à l’ère des données et du marketing digital. Les nouveaux moyens de traitement de l’information massive permettent de sélectionner avec toujours plus de finesse le contenu “pertinent” à diffuser pour une personne donnée à un moment donné.

Les modèles de prédiction basés sur des technologies d’intelligence artificielle sont en effet capables de déterminer les contenus à diffuser en fonction des catégories d’individus qu’ils ont identifiés. On peut alors parler d’un “sur-mesure de masse” qui s’incarne à un niveau global.

A l’heure où certaines études scientifiques considèrent que notre capacité d’attention est passée en-dessous du seuil fatidique de celle du poisson rouge, soit 9 secondes, Yves Citton décrit le fonctionnement d’une économie de l’attention au sein de laquelle la course à la rentabilité passe par l’aliénation des masses. Pour se prémunir de cette tendance, il dessine les fondements d’une écologie de l’attention.

                              Pour aller plus loin

[Yves Citton : l’écologie de l’attention](https://vimeo.com/129223397)

                              Le sur-mesure de masse et la dopamine sont au cœur de cette économie de l’attention

Tout commence par du contenu pertinent recommandé par des algorithmes. Mais qu’est ce qui détermine qu’un contenu est pertinent ? Ce sont les habitudes des consommateurs qui vous ressemblent qui viennent déterminer ce que vous allez regarder. Toute trace que vous laissez sur le web vient alimenter les algorithmes. Vous voilà face à une série de suggestions ultra-personnalisées… Et cliquer est tentant ! C’est exactement l’effet recherché : l’économie de l’attention vous garde connectés. Elle profite de vos abonnements jamais résiliés et des données que vous laissez derrière vous quand vous cliquez, ou quand vous ne cliquez pas, d’ailleurs ! Elle s’en sert pour vous construire un service sur-mesure qui vous captera encore plus longtemps.

Avec les offres freemium, proposant un accès gratuit aux services basiques et suffisant pour découvrir et aimer le produit, mais limité. La star de cette économie fait son entrée : la frustration ! Ou plus précisément, la dopamine qui la nourrit. La dopamine, c’est la molécule responsable de la motivation et du plaisir. Malheureusement, elle est aussi responsable de l’addiction.

(l’endorphine est l’hormone sécrétée quand nous faisons du sport et qui nous procure du bien-être)

Le principe est assez simple : vous commencez à utiliser un service ou jouer à un jeu, prenons CandyCrush. Au départ, tout marche comme sur des roulettes, vous enchaînez les réussites, le service comble vos attentes. Vous vous sentez fort, talentueux, compris en tant qu’internaute. Une zone de votre cerveau s’active : vous sécrétez de la dopamine. Par un ingénieux système de félicitations, de récompenses et de stimulis sonores, les jeux comme CandyCrush déclenchent chez vous des micro-shoots constants de dopamine, vous rendant totalement accros.

Et quand vous êtes accros, soudain : vous échouez. Une publicité vient interrompre votre morceau préféré. La frustration pointe le bout de son nez. CandyCrush, Spotify et les autres vous apportent la solution sur un plateau : l’achat des fonctionnalités premium. Fini la pub, et fini de s’arracher les cheveux sur le même niveau pendant des jours.

La dopamine est au coeur des réseaux sociaux tels qu'Instagram. L’homme est un animal social en quête d’approbation, et chaque petit like, chaque petit follower équivaut à un micro-shoot de dopamine. Du coup, on se connecte, on participe… et on ne voit plus la différence entre le contenu spontané des utilisateurs et le contenu “sponsorisé” dont regorgent nos fils d'actualité et les publications de nos influenceurs, chéris par les marques et que nous souhaitons imiter. Résultat : les annonceurs s’en donnent à coeur-joie, et on n’en a même pas conscience.

                              Pour aller plus loin

[Dopamine - Spécial Confinement](https://www.arte.tv/fr/videos/085801-010-A/dopamine/)
[Le capitalisme produit une crise de l’attention](https://www.lesinrocks.com/livres/yves-citton-il-ny-pas-dattention-en-dun-environnement-relationnel-105507-25-09-2014/)
[Comment réguler l’exploitation de notre attention ?](https://www.lemonde.fr/blog/internetactu/2018/12/27/comment-reguler-lexploitation-de-notre-attention/)

---

---

title: Technique d'apprentissage de Richard Feynman

> _“the first principle is that you must not fool yourself - and you are the easiest person to fool.”_ — Richard P. Feynman

Le but de cette technique d'apprentissage est d'être capable d'expliquer le concept à quelqu'un d'autre de façon simple. Il est nécessaire de comprendre ce concept afin d'utiliser des termes simples pour vulgariser un sujet complexe.

> _"Si vous ne pouvez pas l'expliquer simplement, c'est que vous ne le comprenez pas assez bien."_ — Albert Einstein
...
Choisir un sujet. Sur une feuille blanche, écrire tous ce que l'on sait sur le sujet, comme si nous étions en train d'enseigner ce sujet à un enfant de 11 ans, ou à un canard en plasstique sur son bureau... Il est important d'utililser des mots simples, il faut supprimer les mots et expressions technique ainsi que le jargon. Souvent ces termes permettent de dissimuler un manque de compréhension, ils ne sont qu'une répition de ce nous avons entendus ailleurs.

Il est important, également, d'être concis. L'attention d'un enfant est limité, il ne peut rester concentré que quelques minutes. À chaque fois que nous découvrons quelques choses de nouveau sur le sujet, il faut l'ajouter sur la note.

### 2. Identifier les trous dans les explications.

Les passages difficile, ceux manquant de clareté, sont les éléments à retraivailler. Il est nécessaire de repartir des sources, livres, vidéos youtube, articles, etc.

### 3. Organisation et simplification

Chaque note doit décrire un unique sujet, c'est une structure atomique dans le sens des [[notes atomiques]] du zettelkasten. On peut regrouper l'ensemble de ces notes par domaines de compétences, par matières, pour créer des présentation ou des cours.

### 4. Transmettre

L'objectif logique de ce processus est la compréhension d'un sujet. La dernière étape est la transmission de ces nouvelles compétences à un public. Cette dernière étape est le meilleur test pour déterminer

Les retours des personnes permettent de vérifier si nous sommes capable de diffuser un sujet simplement.

---

Source : [The Feynman Learning Technique](https://fs.blog/2021/02/feynman-learning-technique/)
...
La procrastination c’est **l’incapacité** d’établir un ordre des priorités.

Conséquences : **stress** et **anxiété**

---

🌅 Note créée le : 27-09-2021
📑 Note éditée le :
...
"l'utilisation d'ordinateurs permet de gérer de manière plus économique et plus fiable les données de l'entreprise, il n'en demeure pas moins que son déploiement obéit à de strictes méthodes qui se sont perfectionnées au cours du temps. Ces méthodes ne s'inventent pas, et une entreprise qui s'aventurerait à confier toutes ses données sensibles à une machine sans respecterces méthodes serait conduite à une faillite certaine." (Favre Bertin 2017:4)

L’objectif d’un audit informatique est d’identifier les sources de panne, et leurs probabilités panne, dans le processus informatique. Le déploiement des systèmes informatiques suivent des méthodologies strictes mises en places à la suite d’expériences négatives, parfois désastreuses, pour les entreprises. Cette méthodologie doit être respectée pour éviter de reproduire ces pannes. C’est pourquoi l’audit est une action préventive.

[[lien avec le cours sur les risques]]

Plongeon dans les modèles mentaux
...
## Utilisez les variables en programmation

### Variables

C'est une notion fondamentale en développement. Une variable est un **conteneur utilisé pour stocker un élément de données** dont un programme pourrait avoir besoin. Une variable peut être vue comme **une boîte qui contient une valeur**. Cette boîte est stockée sur une étagère dans un entrepôt gigantesque, la mémoire de l'ordinateur. L'emplacement de chaque boîte de cet entrepôt est soigneusement enregistré, tout comme l'ordinateur enregistre l'emplacement d'une variable en mémoire. Une donnée placée dans une variable s'appelle une _valeur_.

Pour savoir à quoi sert chaque boîte, on peut les étiqueter. Avec la programmation, c'est la même chose : on peut attribuer un **nom** à une variable. Le nom d'une variable doit refléter la signification de son contenu, comme des étiquettes sur une boîte.

Quelques recommandations générales pour la création de noms :

- **utilisez des noms descriptifs.** Ça risque d'être un peu long, mais les noms descriptifs sont bien pratiques à long terme car ils offrent une meilleure lisibilité et facilitent ainsi la compréhension du code pour les autres développeurs. Par exemple, si vous voulez stocker des cookies sans sucres, l'utilisation d'un nom descriptif comme `cookiesSansSucres` est bien plus précis que `cookies` ou `cookiesSains`.
- **Soyez complet.** Il faut éviter d'abréger ou de raccourcir les mots, même si une version plus courte semble évidente. Par exemple, `chiffreDAffairesAnnuel` est préférable à `chifAfAnn`.
- **Les conventions d'appellation commune.** L'une des conventions d'appellation les plus populaires est le **Camel Case** : une phrase composée de plusieurs mots sans espaces ni ponctuation. Le premier mot est écrit en minuscules et tous les autres mots commencent par une majuscule. Par exemple, `monBudget`.

### La déclaration de variable

Pour utiliser une variable dans votre code, vous devez la créer, ou, en langage de développeur, la **déclarer**. Il existe plusieurs **types** de variables en Java, qui seront utilisées en fonction du type de valeur qu'elles contiennent. En continuant l'analogie des boîtes, elles peuvent stocker différentes choses, des chaussures, un stylo, de l'argent, des photos, etc. Les variables peuvent, elles aussi, stocker plusieurs _type_ de valeur.
...
Ici, deux variables sont déclarées : `ongoingAllowance` (allocationEnCours) et `savings` (épargne). Ces variables stockent respectivement les valeurs de 500 et 1000. En plus de la déclaration, des valeurs initiales sont attribuées aux variables, c'est-à-dire une valeur de départ.

En Java, le type `int` ne stocke que des nombres entiers. Pour utiliser les centimes, il faut utiliser le type `double` , qui stocke les nombres décimaux (ou « flottants »).

### Modifiez la valeur de votre variable avec les opérateurs

Une variable peut varier, c'est-à-dire changer de valeur. Pour la faire varier, on peut utiliser les opérateurs mathématique. Avec les variables `ongoingAllowance` et `savings` de l'exemple précédent, on peut :
...
Les opérateurs arithmétiques basique :
...
Les règles arithmétiques habituelles s'appliquent en code : PEMDAS !
...
> Les lignes qui commencent par `//` sont des commentaires. Elles servent à aider d’autres personnes à comprendre le code.

Les **affectation** assigne une valeur à une variable. Une affection est composée de trois éléments :

- l'**opérateur** d'affectation est `=` ;
- à gauche de l'opérateur d'affectation, le nom de la variable à laquelle vous voulez que le résultat corresponde ;
- à droite de l'opérateur d'affectation, une expression.

> Pour _affecter_ une valeur à une variable, on écrit une affectation. Cette affectation se compose du nom de la variable, suivie de l'opérateur d'affectation, et enfin de l'expression qui produit une valeur correspondant au _type_ de la variable.

#### Les opérateurs d'affectation raccourcis

Chaque affectation attribue une valeur à une variable. On peut directement assigner une valeur à droite de l'opérateur d'affectation.
...
Au lieu d'utiliser `savings + 100` et l'opérateur d'affectation `=`, on peut combiner l’opérateur d'affectation et l'opérateur arithmétique : `+=`
...
Les autres variantes raccourcis sont :
...
### Les autres type de variables

l'exemple que nous avons utilisé, toutes les variables stDansockent des montants d'argent, qui sont des nombres.
...
Jusqu'à présent, vous avez vu les composantes suivantes d'une variable : nom et valeur. Enfin, pour pouvoir stocker différents contenus dans les boîtes (ou bocaux), vous devez définir le type de la variable. Tout comme le stockage de l'argent nécessite un conteneur différent de celui d'un livre, différentes variables utilisent également un espace de stockage différent en fonction de leur type.
...
Une femme tape un document sur son ordinateur
Imaginez avoir à faire cela à la main avec votre document !
...
Veuillez noter que lorsque vous affectez une valeur à une variable lors de sa déclaration, vous devez indiquer explicitement le type de variable dont il s'agit. Pour ce faire, ajoutez le type dans votre déclaration en utilisant les mots clés int, String ou double dans notre cas ci-dessus.

Découvrez des variables qui ne changent jamais
Jusqu'à présent, la plupart des valeurs changeaient en fonction des circonstances (ajouter de l'argent aux économies, augmenter le nombre de voyelles). Certaines valeurs, cependant, n'ont pas besoin d'être modifiées. Elles restent exactement telles qu'elles ont été définies au départ. Une variable avec une valeur qui ne change pas s'appelle une constante. Tout comme les autres variables, les constantes sont décrites par trois composantes : nom, valeur et type. La seule différence est qu'une fois que vous l'avez définie, la valeur d'une constante ne peut plus être modifiée.
...
Vérifiez que certaines valeurs ne changent pas, que ce soit intentionnellement ou par accident. Par exemple, vous ne voudriez pas modifier les jours de la semaine ou le nombre de jours dans une année. ??
...
En résumé
Dans ce chapitre, vous avez découvert les variables :
...
Dans le chapitre suivant, nous nous pencherons plus en détail sur le sujet des types ! ??

#

INDIQUER QUE CE CHAPITRE N'EST PAS TERMINÉ
TIREZ LE MAXIMUM DE CE COURS CHOISISSEZ LE BON TYPE D’UNE VARIABLE

## Choisissez le bon type de variable

## Ecrivez une fonction principale propre

> Pour aborder ce chapitre, je dois vous présenter la notion de **classe**. Une classe est un ensemble de variables, nommées **attributs**, et de comportements, nommés **méthodes**. Les classes représentent les patrons de construction des objets de votre programme. Nous y reviendrons dans la deuxième partie de ce cours.

Une **fonction** est un bloc de code avec un nom, pour l'identifier, qui exécute un service.

En java, la fonction :

    main

le "service" effectué par cette fonction est en fait le programme lui-même !

Lorsqu'une fonction est située à l'intérieur d'une **classe**, elle s'appelle une **méthode**. Puisque tout le code est situé à l'intérieur de classes, les deux termes, fonctions et méthodes, sont interchangeables.
...
Petite explication des lignes codes

    package hello;

Il s'agit d'une déclaration de **package** qui permet d'utiliser Hello. On peut faire l'analogie entre package et dossiers.

public class HelloWorld

- Le morceaux de code permet de définir le nom de la classe comme étant : HelloWorld. En Java, l'ensemble du code doit se trouver à l'intérieur d'une classe. Les classes servent de **modèle** pour les objets (ici HelloWorld).
- Les classes définissent l'état de l'objet avec les **champs** et le comportement de l'objet avec les **méthodes**.
- L'analogie entre package et dossier peut continuer avec les classes qui peuvent être assimilées aux fichiers. Aussi, les classes sont contenues dans les packages (fichiers dans les dossiers).

  System

Une instruction avec une classe utilitaire nommé System

    public static void main(String[] args)

A l'intérieur d'une classe, la déclaraton de la fonction. C'est le morceaux de code que l'interpréteur de Java recherche lorsqu'on démarre un programme.

> Le **compilateur** intervient en amont pour interpréter le code et le transformer en byteCode (ou code binaire). Puis l'**interpréteur** traduit le byteCode en instructions pour exécuter le programme.

    /**
    *
    */

Ce sont des commentaires de documentation. Ces commentaires créent un **javadoc**, une page web HTML contenant la documentation pour le code. Il contient aussi, une liste de classe, de méthodes, et de variables.

---

## Références

[Débutez la programmation avec Java](https://openclassrooms.com/fr/courses/6173501-debutez-la-programmation-avec-java)

---

🌅 Note créée le : 29-09-2021
📑 Note éditée le :

- [Utilisez les variables en programmation](#utilisez-les-variables-en-programmation)
  - [Variables](#variables)
  - [La déclaration de variable](#la-déclaration-de-variable)
  - [Modifiez la valeur de votre variable avec les opérateurs](#modifiez-la-valeur-de-votre-variable-avec-les-opérateurs)
    - [Les opérateurs d'affectation raccourcis](#les-opérateurs-daffectation-raccourcis)
  - [Les autres type de variables](#les-autres-type-de-variables)
- [Choisissez le bon type de variable](#choisissez-le-bon-type-de-variable)
- [Ecrivez une fonction principale propre](#ecrivez-une-fonction-principale-propre)
  - [Hello World](#hello-world)
- [Références](#références)

---

title: Booléen en programmation
type: star
tags: #python #code

---

les booléens sont un [[types-variable-programmation]] de variable appelée `bool`, avec deux valeurs possible : `True` et `False`. Bien souvent les valeurs `True` ou `False` ne sont pas insérer directement dans le code, mais elles proviennent d’**opérateurs booléens**. Ils répondent oui/non aux questions.

## Opérateurs de comparaison (Comparison Operations)
...
- `and` : l’opérateur logique `and` renvoie `True`, si et seulement si, **toutes** les conditions sont `True`. Il permet de lier plusieurs conditions entre elles.
- `or` : l’opérateur logique `or` renvoie `True`, si l’une des conditions est `True`. Il permet de lier plusieurs conditions **alternatives** entre elles. Pour que l’opérateur logique `or` renvoie `False`, il faut que toutes les conditions soient `False`.
- `not` : l’opérateur logique `False` permet d’inverser le résultat logique d’un test dans une condition. Il renverra `False` pour un test évalué `True`, et inversement, il renverra `True` pour un test évalué `False`.
