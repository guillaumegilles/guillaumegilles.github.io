---
title: "ECB's Interest Rates"
type:
tags: []
---

The key short-term interest rates are one of the [four monetary policy instuments](monetary-policy.qmd)
held by the ECB. The ECB sets three interest rates:

- **Rate on main refinancing operations** (_taux des opérations de refinancement_): the rate at which banks can borrow from Eurosystem central banks.
- **Deposit facility rate** (_taux de facilité des dépôts_): the rate commercial banks earn on their overnight deposits with Eurosystem central banks.
- **Rate on the marginal lending facility** (_taux de facilité de prêt marginal_): the rate at which Eurosystem central banks provide overnight credit to commercial banks.
