...
Daily notes can also make use of [notes template](foam-tempaltes), by defining
...
using the special [note metadata](foam-yaml.qmd) inside a [Foam template](foam-tempaltes.qmd).
