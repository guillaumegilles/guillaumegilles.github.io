...
An activation function is simply some function we apply to each of a layer's
outputs (its **activation**). the most common activation function is the
_rectifier_ function $max(0, x)$.
