...
Economist and Statistician	Banque de France	2020 – Present
    • Responsible for macroeconomic analysis and forecasting for the Nouvelle-Aquitaine region, covering key topics such as inflation, economic growth, and regional trends.
    • Monthly production of comprehensive reports on regional economic trends, providing strategic insights for local business leaders.
    • Actively involved in scenario development and data analysis in collaboration with other regional institutions.
Statistics Lecturer	ESSCA Bordeaux	2024 – Present
    • Teaching descriptive and inferential statistics to students in the Grande École program, with a tailored pedagogical approach to meet diverse student levels.
    • Designed teaching materials and practical case studies focused on applying statistical concepts in decision-making.
Financial Analysis Lecturer	INSEEC MSc & MBA	2019 – Present
    • Delivered theoretical and practical courses in financial analysis to master's students, focusing on financial statement analysis, business valuation techniques, and risk management.
    • Developed real-world case studies to enhance the understanding and application of key financial concepts.
Senior Financial Analyst	Banque de France	2011 – 2020
    • Conducted in-depth solvency assessments of major French companies, specializing in consolidated accounts under IAS/IFRS and French accounting standards.
    • Evaluated default risks and provided recommendations on credit limits, enabling commercial banks to access interbank market financing.
    • Produced detailed financial reports to support strategic decision-making by banking institutions.
Education
Data Science Certification	ENSAE – ENSAI Formation Continue (CEPE)	2023
Acquired expertise in machine learning and deep learning techniques, including SVM, boosting, and neural networks. Completed a capstone project to apply theoretical knowledge throughout the program.
Master’s in Computer Science for Business (MIAGE) 	Université de Bordeaux	2020 – 2022
